  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        // Luxury Blackjack Theme Colors (preserved)
        onyx: '#0F1115',
        onyxLight: '#14161B',
        champagne: '#D9C38C',
      ...
      minHeight: {
        ...
        'touch-mobile': '48px', // Enhanced touch target for mobile
      },
  ...
  plugins: [
    ...
    function({ addUtilities, theme }) {
      const newUtilities = {
        ...
        '.touch-target-mobile': {
          'min-height': theme('minHeight.touch-mobile'),
          'min-width': theme('minWidth.touch-mobile'),
        },
