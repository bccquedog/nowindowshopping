...
export const CoachCareLanding: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-blue-900 dark:via-indigo-900 dark:to-purple-900 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl w-full">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          <div className="text-center">
            <div className="mx-auto h-10 w-10 bg-green-100 dark:bg-green-900 rounded-full flex items-center justify-center mb-3">
              <svg className="w-5 h-5 text-green-600 dark:text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
            </div>
            <h3 className="font-semibold text-gray-900 dark:text-white mb-1">Proven Results</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400">Transformative coaching that delivers measurable outcomes</p>
          </div>
          
          <div className="text-center">
            <div className="mx-auto h-10 w-10 bg-blue-100 dark:bg-blue-900 rounded-full flex items-center justify-center mb-3">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">Your data and conversations are protected and confidential</p>
          </div>
          
          <div className="text-center">
            <div className="mx-auto h-10 w-10 bg-purple-100 dark:bg-purple-900 rounded-full flex items-center justify-center mb-3">
              <svg className="w-5 h-5 text-purple-600 dark:text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
              </svg>
            </div>
            <h3 className="font-semibold text-gray-900 dark:text-white mb-1">Flexible Sessions</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400">Schedule sessions that fit your lifestyle and goals</p>
          </div>
        </div>
